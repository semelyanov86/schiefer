<?php /* Smarty version Smarty-3.1.7, created on 2019-02-11 08:38:54
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19747704575c610a6ecbf204-28019728%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e57b7bb96decd19755f5f00e4677b98a394e4a69' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/QuickCreate.tpl',
      1 => 1549640771,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19747704575c610a6ecbf204-28019728',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c610a6ed83a7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c610a6ed83a7')) {function content_5c610a6ed83a7($_smarty_tpl) {?>
...
<div class="modal-body"><?php if ($_smarty_tpl->tpl_vars['CONTACT_ID']->value){?><input type="hidden" name="contact_id" value="<?php echo $_smarty_tpl->tpl_vars['CONTACT_ID']->value;?>
" /><?php }?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['MSG_NO']->value)&&isset($_smarty_tpl->tpl_vars['FOLDER_NAME']->value)){?>&msgno=<?php echo $_smarty_tpl->tpl_vars['MSG_NO']->value;?>
&foldername=<?php echo $_smarty_tpl->tpl_vars['FOLDER_NAME']->value;?>
<?php }?><?php if (isset($_smarty_tpl->tpl_vars['CONTACT_ID']->value)){?>&contact_id=<?php echo $_smarty_tpl->tpl_vars['CONTACT_ID']->value;?>
<?php }?>" type="button"><strong><?php echo vtranslate('LBL_GO_TO_FULL_FORM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
