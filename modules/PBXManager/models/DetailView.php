...
class PBXManager_DetailView_Model extends Vtiger_DetailView_Model
{
    ...
    public function getDetailViewLinks($linkParams)
    {
        ...
        $linkModelListDetails = Vtiger_Link_Model::getAllByType(
            $moduleModel->getId(),
            $linkTypes,
            $linkParams
        );
        ...
        if (Users_Privileges_Model::isPermitted($moduleName, 'Delete', $recordId)) {
            $linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues([
                 ...
                 'linklabel' => sprintf(
                     "%s %s",
                     getTranslatedString('LBL_DELETE', $moduleName),
                     vtranslate('SINGLE_'. $moduleName, $moduleName)
                 ),
            ...
            $linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues([
                'linktype' => 'DETAILVIEW',
                'linklabel' => 'Не требует перезвона',
                'linkurl' => 'index.php?module=PBXManager&action=notNeededCall&recordid='.$recordId ,
                'linkicon' => ''
            ]);
        }
        ...
        $linkModelList['DETAILVIEW'][] = Vtiger_Link_Model::getInstanceFromValues([
            'linktype'  => 'DETAILVIEW',
            'linklabel' => vtranslate('Select Customer'),
            'linkurl'   => 'javascript:setCustomer()' ,
            'linkicon'  => ''
        ]);
