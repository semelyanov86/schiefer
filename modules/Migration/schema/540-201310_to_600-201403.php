...
$potentailsWorkFlow->description = vtranslate("LBL_WORKFLOW_FORECAST_AMOUNT","Install");
...
$inventoryModules = array('Invoice','SalesOrder','PurchaseOrder','Quotes', 'Act', 'Consignment');
...
Migration_Index_View::ExecuteQuery("INSERT INTO vtiger_ws_entity_referencetype(fieldtypeid,type) VALUES (?,?)",array($fieldTypeId,'Act'));
Migration_Index_View::ExecuteQuery("INSERT INTO vtiger_ws_entity_referencetype(fieldtypeid,type) VALUES (?,?)",array($fieldTypeId,'Consignment'));
...
Migration_Index_View::ExecuteQuery("UPDATE vtiger_ws_entity SET handler_path='include/Webservices/LineItem/VtigerInventoryOperation.php',handler_class='VtigerInventoryOperation' where name in ('Invoice','Quotes','PurchaseOrder','SalesOrder','Act','Consignment');",array());
...
//Salesplatform.ru begin Remove multiply workflow
...
//Salesplatform.ru end Remove multiply workflow
...
//Salesplatform.ru begin
$commentsWorkflow->description = vtranslate("LBL_WORKFLOW_FOR_TICKET_COMMENTS","Install");
...
$inventoryModules = array(
    ...
    'Act' => array('LBL_ACT_INFORMATION', 'vtiger_sp_act', 'actid'),
    'Consignment' => array('LBL_CONSIGNMENT_INFORMATION', 'vtiger_sp_consignment', 'consignmentid'),
...
//SalesPlatform.ru begin
$poWorkFlow->description = vtranslate('LBL_UPDATE_INVENTORY_PRODUCTS', 'Install');
...
$task->active = true;
//SalesPlatform.ru begin
$task->summary = vtranslate('LBL_UP_INV_PRODUCTS', 'Install');
...
$modules = array('Invoice','Quotes','PurchaseOrder','SalesOrder', 'Act', 'Consignment');
