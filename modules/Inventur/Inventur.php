...
class Inventur extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_inventur';
	var $table_index= 'inventurid';
	var $related_tables = Array ('vtiger_inventurcf' => Array ( 'inventurid', 'vtiger_inventur', 'inventurid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_inventurcf', 'inventurid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_inventur', 'vtiger_inventurcf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_inventur' => 'inventurid',
		'vtiger_inventurcf'=>'inventurid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_inventur, vtiger_users,
                ...
                vtiger_inventur.inventurid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_inventur.inventurid = $id AND
