...
/**
 * Class Inventur_Uninstall_View
 */
class Inventur_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_inventurcf table
        echo "&nbsp;&nbsp;- Delete vtiger_inventurcf table.";
        $result = $adb->pquery("DROP TABLE vtiger_inventurcf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_inventur table
        echo "&nbsp;&nbsp;- Delete vtiger_inventur table.";
        $result = $adb->pquery("DROP TABLE vtiger_inventur");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
