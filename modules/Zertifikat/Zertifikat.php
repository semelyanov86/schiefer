...
class Zertifikat extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_zertifikat';
	var $table_index= 'zertifikatid';
	var $related_tables = Array ('vtiger_zertifikatcf' => Array ( 'zertifikatid', 'vtiger_zertifikat', 'zertifikatid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_zertifikatcf', 'zertifikatid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_zertifikat', 'vtiger_zertifikatcf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_zertifikat' => 'zertifikatid',
		'vtiger_zertifikatcf'=>'zertifikatid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_zertifikat, vtiger_users,
                ...
                vtiger_zertifikat.zertifikatid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_zertifikat.zertifikatid = $id AND
