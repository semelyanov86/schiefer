...
/**
 * Class Zertifikat_Uninstall_View
 */
class Zertifikat_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_zertifikatcf table
        echo "&nbsp;&nbsp;- Delete vtiger_zertifikatcf table.";
        $result = $adb->pquery("DROP TABLE vtiger_zertifikatcf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_zertifikat table
        echo "&nbsp;&nbsp;- Delete vtiger_zertifikat table.";
        $result = $adb->pquery("DROP TABLE vtiger_zertifikat");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
