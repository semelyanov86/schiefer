...
{strip}
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix">
			<span class="col-xs-10 col-lg-7 col-md-7 col-sm-7">
				<span>
				...
				<span>
					<p class="current-filter-name pull-left">&nbsp;&nbsp;<span class="ti-angle-right" aria-hidden="true"></span>
				...
				{if $VIEWNAME}
					...
					{/if}
					<span>
						<p class="current-filter-name filter-name pull-left">&nbsp;&nbsp;<span class="ti-angle-right" aria-hidden="true"></span> {$FOLDERNAME} </p>
					</span>
				{/if}
			</span>

			<span class="col-xs-2 col-lg-5 col-md-5 col-sm-5 pull-right">
					...
					{foreach item=LISTVIEW_BASICACTION from=$LISTVIEW_LINKS['LISTVIEWBASIC']}
						...
						{if $childLinks && $LISTVIEW_BASICACTION->get('linklabel') == 'LBL_ADD_RECORD'}
							<span class="btn-group">
								<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" id="{$MODULE}_listView_basicAction_Add">
									<i class="ti-plus"></i>
									<span class="hidden-sm hidden-xs">
										&nbsp;{vtranslate($LISTVIEW_BASICACTION->getLabel(), $MODULE)}</span>
