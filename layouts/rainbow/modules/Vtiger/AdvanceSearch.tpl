...
-->*}
{strip}
    <div id="searchResults-container" class="animated bounceInDown">
        <div class="row">
                            ...
                            <div class="btn-toolbar">
                                ...
                                <div class="btn-group ">
                                    {if $SAVE_FILTER_PERMITTED}
                                        ...
                                        <button class="btn btn-success" {if $SOURCE_MODULE eq 'Home'} disabled="" {/if} id="advanceIntiateSave"><i class="ti-save"></i> <strong>{vtranslate('LBL_SAVE_AS_FILTER', $MODULE)}</strong></button>
