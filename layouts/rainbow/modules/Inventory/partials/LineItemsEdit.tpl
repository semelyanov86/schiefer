		...
		<div class='fieldBlockContainer'>
			<div class="row">
				<div class="col-lg-12 col-xs-12">
							<h3 class='fieldBlockHeader' style="">&nbsp;&nbsp;&nbsp;{vtranslate($BLOCK_LABEL, $MODULE)}</h3>
				</div>
				<div class="clearfix"></div>
				<div class="col-lg-4 col-xs-12 text-center" style="margin-top: 10px;">
			...
			<div class="lineitemTableContainer">
				<table class="table table-bordered" id="lineItemTab" style="margin-top: 10px">
					<tr>
