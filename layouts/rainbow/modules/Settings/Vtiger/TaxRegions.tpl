		...
		<div class="tab-content overflowVisible">
			...
			<div class="col-lg-4 marginLeftZero textOverflowEllipsis">
				<div class="marginTop10px marginBottom10px">
					<button type="button" class="btn btn-primary addRegion addButton " data-url="?module=Vtiger&parent=Settings&view=TaxAjax&mode=editTaxRegion" data-type="1">
						...
						<tr class="opacity" data-key-name="{$TAX_REGION_NAME}" data-key="{$TAX_REGION_NAME}">
							...
							<td class="{$WIDTHTYPE}" style="border-right:none;border-left:none">
								<div class="pull-right actions">
									<a class="editRegion" data-url='{$TAX_REGION_MODEL->getEditRegionUrl()}'><i title="{vtranslate('LBL_EDIT', $QUALIFIED_MODULE)}" class="ti-pencil alignMiddle"></i></a>&nbsp;&nbsp;
									<a class="deleteRegion" data-url='{$TAX_REGION_MODEL->getDeleteRegionUrl()}'><i title="{vtranslate('LBL_DELETE', $QUALIFIED_MODULE)}" class="ti-trash alignMiddle"></i></a>
								</div>
							</td>
						</tr>
					{/foreach}
			...
			<div class="col-lg-7">
				<br><br><br>
				<div class="">
					<div class="col-lg-1"><i class="ti-info-alt"></i></div>
