...
<div class="chargesContainer">
	...
	<div class="col-lg-6">
		<div class="marginBottom10px">
			<button type="button" class="btn btn-primary addCharge addButton marginTop10px marginBottom10px" data-url="{Inventory_Charges_Model::getCreateChargeUrl()}" data-type="1">
				...
				<tr class="opacity" data-charge-id="{$CHARGE_MODEL->getId()}">
					...
					<td class="{$WIDTHTYPE}" style="border-right:none;border-left:none">
						<div class="pull-right actions">
							<a class="editCharge cursorPointer" data-url="{$CHARGE_MODEL->getEditChargeUrl()}"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="ti-pencil alignMiddle"></i></a>
						</div>
					</td>
				</tr>
			{/foreach}
	...
	<div class="col-lg-6">
		<div class="marginBottom10px">
			<button type="button" class="btn btn-primary addChargeTax addButton marginTop10px marginBottom10px" data-url="{$CREATE_TAX_URL}" data-type="1">
			...
			{foreach item=CHARGE_TAX_MODEL from=$CHARGE_TAXES}
				<tr class="opacity" data-taxid="{$CHARGE_TAX_MODEL->get('taxid')}" data-taxtype="{$CHARGE_TAX_MODEL->getType()}">
					...
					<td style="border-left:none;border-right:none;" class="{$WIDTHTYPE}">
						<div class="pull-right actions">
							<a class="editChargeTax cursorPointer" data-url="{$CHARGE_TAX_MODEL->getEditTaxUrl()}"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="ti-pencil alignMiddle"></i></a>
						</div>
					</td>
				</tr>
			{/foreach}
