			...
			<div class="blockData">
				<div class="clearfix">
					<div class="btn-group col-xs-12">
						<button type="button" class="pull-right btn addButton btn-primary " name="updateRecordWithSequenceNumber">{vtranslate('LBL_UPDATE_MISSING_RECORD_SEQUENCE', $QUALIFIED_MODULE)}</button>
					</div>
					<div class="col-xs-12">
