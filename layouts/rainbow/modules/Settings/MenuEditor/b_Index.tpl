...
<div class="listViewPageDiv detailViewContainer col-sm-12 " >
	<div class="col-sm-12">
		<div class="row">
	...
	<div class="row overrow">
		...
		{foreach item=APP_IMAGE key=APP_NAME from=$APP_IMAGE_MAP name=APP_MAP}
			...
			<div style="margin-left:25px;" class=" {if $smarty.foreach.APP_MAP.index eq 0 or count($APP_LIST) eq 1} {/if} col-lg-2 col-xs-2">
