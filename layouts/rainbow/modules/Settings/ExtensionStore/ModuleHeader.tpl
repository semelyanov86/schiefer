			...
			<div class="col-lg-8 col-md-8 col-xs-12">
				<div class="navbar-right">
					<ul class="nav navbar-nav">
						<li>
							{if !($PASSWORD_STATUS)}
								<button class="btn module-buttons" type="button" id="logintoMarketPlace">
									<div class="fa fa-sign-in" aria-hidden="true"></div>
									&nbsp;&nbsp;Login to marketplace
								</button>
							{else}
								<button class="btn module-buttons" type="button" id="{if !empty($CUSTOMER_PROFILE['CustomerCardId'])}updateCardDetails{else}setUpCardDetails{/if}">
									<div class="ti-credit-card" aria-hidden="true"></div>&nbsp;&nbsp;
