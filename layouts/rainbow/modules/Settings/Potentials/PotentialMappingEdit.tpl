                ...
                <form id="potentialsMapping" method="POST">
                    <div class="editViewBody ">
                        <div class="editViewContents table-container"  style="overflow: scroll;">
                            ...
                            <table class="table listview-table-norecords" width="100%"  style="width: 100%;" id="convertPotentialMapping">
                                <tbody>
                                    <tr>
                            ...
                            <div class="row">
                                <span class="col-sm-4">
                                    <button id="addMapping" class="btn btn-primary addButton marginTop10px marginBottom10px" type="button">
                                        <i class="ti-plus"></i>&nbsp;&nbsp;
