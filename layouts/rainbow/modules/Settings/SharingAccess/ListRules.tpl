...
{strip}
    <div class="ruleListContainer">
        <div class="title row">
            ...
            <div class="col-sm-6">
                <div class="pull-right">
                    <button class="btn btn-sm btn-info addButton addCustomRule" type="button" data-url="{$MODULE_MODEL->getCreateRuleUrl()}">
        ...
        <hr>	
            <div class="contents">
                {if $RULE_MODEL_LIST}
                    <table class="table table-bordered table-condensed table-hover customRuleTable">
                        <thead>
                                    ...
                                    <tr class="customRuleEntries">
                                        ...
                                        <td>
                                            ...
                                            <div class="table-actions pull-right">
                                                <span><a href="javascript:void(0);" class="edit" data-url="{$RULE_MODEL->getEditViewUrl()}"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="ti-pencil"></i></a></span>
                                                &nbsp;<span><a href="javascript:void(0);" class="delete" data-url="{$RULE_MODEL->getDeleteActionUrl()}"><i title="{vtranslate('LBL_DELETE', $MODULE)}" class="ti-trash"></i></a></span>
                                            </div>
                                        </td>
                                    </tr>
                                {/foreach}
