            ...
            <div class="editViewContainer ">
                <form id="leadsMapping" method="POST">
                    <div class="editViewBody ">
                        <div class="editViewContents table-container"  style="overflow: scroll;">
                            <input type="hidden" id="restrictedFieldsList" value={ZEND_JSON::encode($RESTRICTED_FIELD_IDS_LIST)} />
                            <table class="table listview-table-norecords" style="width: 100%;" width="100%" id="convertLeadMapping">
                                <tbody>
                                    <tr>
                                        <th width="7%"></th>
                                                    ...
                                                    {foreach item=LINK_MODEL from=$MODULE_MODEL->getMappingLinks()}
                                                        <div class="table-actions">
                                                            <span class="actionImages">
                                                                <i title="{vtranslate($LINK_MODEL->getLabel(), $MODULE)}" class="ti-trash deleteMapping"></i>
                                                            </span>
                                                        </div>
                                                    {/foreach}
                                                {/if}
                            ...
                            <div class="row">
                                <span class="col-sm-4">
                                    <button id="addMapping" class="btn addButton btn-primary marginTop10px marginBottom10px" type="button">
                                ...
                                <span class="col-sm-8">
                                    <span class="pull-right">
                                        ...
                                        <a class="btn btn-danger cancelLink" type="reset" href="{$MODULE_MODEL->getDetailViewUrl()}">Cancel</a>
                                    </span>
                                </span>
                            </div>
			</div>
