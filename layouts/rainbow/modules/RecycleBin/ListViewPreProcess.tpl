...
<div class="container-fluid app-nav">
    <div class="row">
        {include file="modules/RecycleBin/partials/SidebarHeader.tpl"|myclayout_path}
...
<div class="main-container main-container-{$MODULE}">
        ...
        <div id="sidebar-essentials" class="sidebar-essentials {if $LEFTPANELHIDE eq '1'} hide {/if}">
            {include file="modules/RecycleBin/partials/SidebarEssentials.tpl"|myclayout_path}
        </div>
