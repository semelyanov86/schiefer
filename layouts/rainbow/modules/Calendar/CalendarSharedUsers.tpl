...
<div class="sidebar-widget-contents" name='calendarViewTypes'>
	<div id="calendarview-feeds">
		<ul class="list-group feedslist">
			<li class="activitytype-indicator calendar-feed-indicator" style="border-left:3px solid {$SHAREDUSERS_INFO[$CURRENT_USER_ID]['color']}; background-color: {$SHAREDUSERS_INFO[$CURRENT_USER_ID]['color']};">
				<span>
			...
			{foreach key=ID item=USER from=$SHAREDUSERS}
				{if $SHAREDUSERS_INFO[$ID]['visible'] != '0'}
					<li class="activitytype-indicator calendar-feed-indicator" style="border-left:3px solid {$SHAREDUSERS_INFO[$CURRENT_USER_ID]['color']};">
