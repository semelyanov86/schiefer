	...
	<div class="dropdown-menu dropdown-menu-left">
		<div class="container-fluid" id="vte-advance-menu-nav-hide">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3 essentials-container">
					<div class="row">
						...
						<div class="col-xs-12 group-menu">
				...
				{/if}
				<div class="col-xs-12 col-sm-9 other-container">
					{if $MARKETING.items|count gt 0 || $SALES.items|count gt 0}
					<div class="row">
                        {if $MARKETING.items|count gt 0}
						<div class="col-xs-12 col-sm-6 marketing-container">
							<div class="row">
								<div class="col-xs-12 group-header">
									<div class="row">
										<div class="col-xs-2">
								...
								<div class="col-xs-12 group-menu">
									<div class="row" data-appname="MARKETING">
                                        {foreach item=MENU_ITEM from=$MARKETING.items}
                                            {if $MENU_ITEM.type eq 'Separator'}
												<div class="vte-menu-item col-xs-12 col-sm-6" data-type="separator">
                                            ...
                                            {else}
												<div class="vte-menu-item col-xs-12 col-sm-6 textOverflowEllipsis  textAlignLeft" title="{vtranslate($MENU_ITEM.label, $MENU_ITEM.module)}">
						...
						<div class="col-xs-12 col-sm-6 sales-container">
							<div class="row">
								<div class="col-xs-12 group-header">
									<div class="row">
										<div class="col-xs-2">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 support-container">
							<div class="row">
								<div class="col-xs-12 group-header">
									<div class="row">
										<div class="col-xs-2">
						...
						<div class="col-xs-12 col-sm-6 inventory-container">
							<div class="row">
								<div class="col-xs-12 group-header">
									<div class="row">
										<div class="col-xs-2">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 projects-container">
							<div class="row">
								<div class="col-xs-12 group-header">
									<div class="row">
										<div class="col-xs-2">
						...
						<div class="col-xs-12 col-sm-6 tools-container">
							<div class="row">
								<div class="col-xs-12 group-header">
									<div class="row">
										<div class="col-xs-2">
