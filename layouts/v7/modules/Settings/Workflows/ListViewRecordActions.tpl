...
<div style="width:80px ;">
    ...
    <input style="opacity: 0;" {if $LISTVIEW_ENTRY->get('status')} checked value="on" {else} value="off"{/if} data-on-color="success"  data-id="{$LISTVIEW_ENTRY->getId()}" type="checkbox" name="workflowstatus" id="workflowstatus" data-on-text="{vtranslate('LBL_ACTIVE')}" data-off-text="{vtranslate('LBL_INACTIVE')}">
